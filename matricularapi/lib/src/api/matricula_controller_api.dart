...
class MatriculaControllerApi {
  final Dio _dio;

  final Serializers _serializers;

  const MatriculaControllerApi(this._dio, this._serializers);
  ...
  Future<Response<MatriculaDTO>> matriculaControllerAlterar({
    ...
    final _path = r'/api/v1/matricula/{id}'.replaceAll('{' r'id' '}',
  ...
  Future<Response<MatriculaDTO>> matriculaControllerAtualizaDocumentoMatricula({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'tipoDocumento': encodeQueryParameter(
          _serializers, tipoDocumento, const FullType(String)),
    };
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Uint8List>> matriculaControllerGetTermo({
    ...
    final _path = r'/api/v1/matricula/termo/{caminhodoc}'.replaceAll(
        '{' r'caminhodoc' '}',
  ...
  Future<Response<MatriculaDTO>> matriculaControllerIncluir({
    ...
    final _path = r'/api/v1/matricula';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PageMatriculaDTO>> matriculaControllerListAllPage({
    ...
    final _path = r'/api/v1/matricula/page';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'page':
          encodeQueryParameter(_serializers, page, const FullType(Pageable)),
    };
  ...
  Future<Response<BuiltList<MatriculaDTO>>>
    ...
    final _path = r'/api/v1/matricula/search-fields';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(BuiltList, [FullType(SearchFieldValue)]);
      _bodyData =
          _serializers.serialize(searchFieldValue, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// matriculaControllerSearchFieldsActionMatriculaListagemDto
  /// Realiza a busca pelos valores dos campos informados
  ///
  /// Parameters:
  /// * [searchFieldValue]
  ...
  Future<Response<BuiltList<MatriculaListagemDTO>>>
    ...
    final _path = r'/api/v1/matricula/search-fields-listagem';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PageMatriculaDTO>> matriculaControllerSearchFieldsActionPage({
    ...
    final _path = r'/api/v1/matricula/search-fields/page';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>>
    ...
    final _path = r'/api/v1/matricula/search-fields-listagem-page';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<SearchField>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SearchField>>> matriculaControllerSearchFieldsList({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<SearchField>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(BuiltList, [FullType(SearchField)]),
            ) as BuiltList<SearchField>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<SearchField>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [MatriculaDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MatriculaDTO>> matriculaControllerUploadDocumento({
    required int idMatricula,
    required String tipoDocumento,
    MultipartFile? multipartFile,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [MatriculaDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MatriculaDTO>> matriculaControllerValidaMatricula({
    required MatriculaDTO matriculaDTO,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/matricula/valida';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
