...
// tests for PageControlePeriodoMatriculaDTO
void main() {
  final instance = PageControlePeriodoMatriculaDTOBuilder();
  // TODO add properties to the builder and call build()

  group(PageControlePeriodoMatriculaDTO, () {
    // int totalElements
    ...
    // BuiltList<ControlePeriodoMatriculaDTO> content
